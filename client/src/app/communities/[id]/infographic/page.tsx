...
export default function InfographicPage() {
  ...
  if (!data) return <div className="h-screen flex items-center justify-center bg-[#E3E1DB]">{t('dataNotFound')}</div>;
        ...
        <section className="py-24 px-4 bg-[#1a1a1a] text-[#E3E1DB]">
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center gap-4 mb-16 border-b border-[#E3E1DB]/10 pb-6">
              ...
              <h2 className="text-3xl font-bold font-serif">{t('historicalTimeline')}</h2>
            </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-4 mb-16">
            ...
            <h2 className="text-[#1a1a1a] text-3xl font-bold font-serif">{t('livelihoodSettlement')}</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-20">
            ...
            {stats.settlement && (
              <div>
                <h3 className="text-xs font-bold uppercase tracking-widest text-[#1a1a1a]/50 mb-10 border-b pb-2">{t('settlementPattern')}</h3>
            ...
            {stats.migration && (
              <div className="bg-[#FAFAF9] p-10 border border-[#1a1a1a]/5 rounded-xl shadow-sm">
                <h3 className="text-xs font-bold uppercase tracking-widest text-[#1a1a1a]/50 mb-8 border-b pb-2">{t('migrationLogic')}</h3>
        ...
        <section className="py-24 px-4 bg-[#E3E1DB]">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center gap-4 mb-12">
              ...
              <h2 className="text-[#1a1a1a] text-3xl font-bold font-serif">{t('communityAspirations')}</h2>
            </div>
