...
export default function CommunityDetailPage() {
  ...
  const slug = params.id as string; // The dynamic route param corresponds to the slug
  ...
  useEffect(() => {
    const fetchCommunity = async () => {
      try {
        ...
        // ✅ Extract the actual data object from the response wrapper
  ...
  if (loading) return <div className="h-screen flex items-center justify-center"><Loader2 className="animate-spin text-[#99302A]" /></div>;
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FAFAF9]">
        <div className="text-center">
          ...
          <Link href="/communities" className="text-[#99302A] hover:underline">Return to list</Link>
        </div>
      </div>
    );
  }
      ...
      <section className="relative h-[70vh] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 w-full px-4 pb-12">
          <div className="max-w-5xl mx-auto">
            <Link 
              href="/communities"
              className="flex items-center gap-2 text-[#E3E1DB] hover:text-[#99302A] transition-colors mb-8 w-fit"
            >
            ...
            <div className="flex flex-wrap items-center gap-6">
              ...
              <Link 
                // ✅ Use slug for the infographic link
