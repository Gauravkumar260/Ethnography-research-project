...
export default function UploadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Assumes your backend docRoutes are set up for this
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] py-12 px-4">
      <div className="max-w-3xl mx-auto">
        <Link href="/admin-panel" className="flex items-center gap-2 text-[#1a1a1a]/60 hover:text-[#99302A] mb-6 transition-colors font-medium">
